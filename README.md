...
Analysed logistics and inventory data using Excel and SQL. Built dashboards monitoring stock levels, shipments, and delivery SLAs. Used SAP reporting tools to support data-backed supply chain decisions.

**AI/ML Intern — VDOIT Technologies** *(Jun 2023 – Jul 2023)*
Built a Python-based AI chatbot using NLP and OpenAI GPT. Integrated Twilio, 360dialog, and Meta APIs with AWS deployment. Shipped the solution for a live client website.
...
**Senior Secondary** | DAV Public School, Ballabhgarh *(2018–2020)* | 85%
...
### 💬 Open to Data Analytics, Business Intelligence & AI/ML roles
